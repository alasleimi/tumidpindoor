...
### paper-condition (privileged, paper-matched) map

| Rank | Method | Mean m | RMSE m | Median m | P90 m | Reduction [95% CI] m |
|---:|---|---:|---:|---:|---:|---:|
...
### environment-blind deployable map
...
### protocol-independent direct/pooled-VT
...
## Statistically confirmed positive reductions

- room_a / protocol_independent / PointNet (multimodal): 4.8960 m [4.7458, 5.0563].
- room_a / protocol_independent / Set attention (multimodal): 4.7080 m [4.5606, 4.8546].
- room_a / protocol_independent / Beta-marginal VT survival: 4.4050 m [4.2498, 4.5609].
- room_a / environment_blind_map / Range--AoA Chamfer: 4.3312 m [4.1761, 4.4940].
- room_a / paper_condition_map / Range--AoA Chamfer: 4.3054 m [4.1533, 4.4588].
- room_a / environment_blind_map / Candidate self-attention: 3.8863 m [3.7229, 4.0561].
- room_a / environment_blind_map / Candidate PointNet reranker: 3.7992 m [3.6508, 3.9651].
- room_a / environment_blind_map / Analytic-anchor residual: 3.6377 m [3.4814, 3.7985].
- room_a / protocol_independent / Survival-CIR + ToA ExtraTrees: 3.4019 m [3.2431, 3.5605].
- room_a / protocol_independent / CAEZ CIR probability MLP: 3.3515 m [3.1735, 3.5241].
- room_a / protocol_independent / Assigned-VT inverse consensus: 3.3454 m [3.1764, 3.5113].
- room_a / environment_blind_map / Range--power Chamfer: 3.3423 m [3.1682, 3.5048].
- room_a / paper_condition_map / Range--power Chamfer: 3.3255 m [3.1626, 3.5013].
- room_a / environment_blind_map / Genuine candidate cross-attention: 3.1346 m [2.9708, 3.2923].
- room_a / paper_condition_map / Chamfer + softmax top-3: 3.0990 m [2.9244, 3.2757].
- room_a / environment_blind_map / Chamfer + softmax top-3: 3.0933 m [2.9098, 3.2672].
- room_a / environment_blind_map / Subset consensus: 3.0771 m [2.9182, 3.2378].
- room_a / paper_condition_map / Subset consensus: 3.0726 m [2.9023, 3.2489].
- room_a / environment_blind_map / Chamfer + inverse top-3: 3.0675 m [2.8994, 3.2313].
- room_a / paper_condition_map / Chamfer + inverse top-3: 3.0651 m [2.9090, 3.2297].
- room_a / environment_blind_map / EvoMDP frozen transfer: 3.0474 m [2.8772, 3.2226].
- room_a / paper_condition_map / EvoMDP frozen transfer: 3.0309 m [2.8618, 3.2032].
- room_a / protocol_independent / PointNet (delay): 3.0052 m [2.8455, 3.1675].
- room_a / paper_condition_map / Graph diffusion: 2.9283 m [2.7543, 3.1016].
- room_a / paper_condition_map / Corrected MPUrge--MAP: 2.9008 m [2.7270, 3.0772].
- room_a / environment_blind_map / Graph diffusion: 2.8817 m [2.7153, 3.0539].
- room_a / environment_blind_map / Corrected MPUrge--MAP: 2.8506 m [2.6905, 3.0110].
- room_a / protocol_independent / Majid CNN regressor: 2.7161 m [2.5622, 2.8789].
- room_a / environment_blind_map / RRLE map-aware MoE: 2.5256 m [2.3661, 2.6957].
- room_a / paper_condition_map / Majid MCA ($\epsilon=2$): 2.4454 m [2.2282, 2.6462].
- room_a / environment_blind_map / Majid MCA ($\epsilon=2$): 2.3971 m [2.1986, 2.6163].
- room_b / protocol_independent / PointNet (multimodal): 2.0944 m [2.0025, 2.1874].
- room_a / environment_blind_map / Majid MCA ($\epsilon=1$): 2.0416 m [1.8282, 2.2667].
- room_a / paper_condition_map / Majid MCA ($\epsilon=1$): 2.0168 m [1.7949, 2.2299].
- room_b / protocol_independent / Set attention (multimodal): 1.7961 m [1.6957, 1.8910].
- room_b / protocol_independent / Beta-marginal VT survival: 1.7538 m [1.6620, 1.8492].
- room_b / environment_blind_map / Range--AoA Chamfer: 1.7316 m [1.6386, 1.8277].
- room_b / paper_condition_map / Range--AoA Chamfer: 1.6409 m [1.5410, 1.7367].
- room_b / environment_blind_map / Candidate self-attention: 1.3231 m [1.2292, 1.4212].
- room_b / environment_blind_map / Candidate PointNet reranker: 1.1953 m [1.0988, 1.2925].
- room_b / protocol_independent / CAEZ CIR probability MLP: 1.1569 m [1.0427, 1.2581].
- room_b / environment_blind_map / Analytic-anchor residual: 0.9399 m [0.8435, 1.0372].
- room_b / protocol_independent / Survival-CIR + ToA ExtraTrees: 0.9142 m [0.8247, 1.0022].
- room_b / environment_blind_map / Range--power Chamfer: 0.8354 m [0.7233, 0.9422].
- room_b / paper_condition_map / Range--power Chamfer: 0.7670 m [0.6501, 0.8773].
- room_b / environment_blind_map / Chamfer + softmax top-3: 0.6097 m [0.4829, 0.7286].
- room_b / environment_blind_map / Genuine candidate cross-attention: 0.5602 m [0.4591, 0.6557].
- room_b / environment_blind_map / EvoMDP frozen transfer: 0.5508 m [0.4439, 0.6670].
- room_b / paper_condition_map / Chamfer + softmax top-3: 0.5264 m [0.4074, 0.6510].
- room_b / environment_blind_map / Subset consensus: 0.3816 m [0.2904, 0.4701].
- room_b / environment_blind_map / Chamfer + inverse top-3: 0.3744 m [0.2817, 0.4671].
- room_b / protocol_independent / Assigned-VT inverse consensus: 0.3658 m [0.2471, 0.4861].
- room_b / paper_condition_map / EvoMDP frozen transfer: 0.3615 m [0.2419, 0.4828].
- room_b / paper_condition_map / Subset consensus: 0.3401 m [0.2419, 0.4362].
- room_b / paper_condition_map / Chamfer + inverse top-3: 0.3358 m [0.2409, 0.4359].
- room_b / protocol_independent / PointNet (delay): 0.3341 m [0.2448, 0.4224].

## Integrity

- Rows: 115,200 / expected 115,200.
- Unique methods: 25.
- Frozen runner SHA-256: `a5aa5f18b9807116df3bf54e0546a12b5dcc98a886c9cb447769f65bc45d9d90`.
- Frozen receiver SHA-256: `10962bf2ab1edf3495879c2693f3e75ad1aeabf68c5af359d9f108645d3b5e67`.
